          ...
          <div className="flex flex-col flex-1 overflow-y-auto">
            ...
            <div className="p-6 border-b border-zinc-850">
              <Link href="/" className="flex items-center gap-2">
                <span className="text-xl font-bold bg-gradient-to-b from-white to-zinc-400 bg-clip-text text-transparent">
                  RazorGrowth AI
                </span>
                <span className="text-[10px] px-1.5 py-0.5 rounded bg-zinc-800 text-zinc-300 border border-zinc-700 font-mono font-medium">
                  COPILOT
                </span>
              </Link>
            ...
            <nav className="p-4 flex-1 space-y-1">
              <Link
                href="/"
                className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-zinc-400 hover:bg-zinc-800 hover:text-zinc-100 transition-colors"
              >
