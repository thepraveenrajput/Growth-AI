  ...
  return (
    <div className="flex-1 flex flex-col overflow-y-auto bg-zinc-950">
      ...
      <header className="px-8 py-7 bg-zinc-900 border-b border-zinc-800 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-lg font-bold text-white tracking-tight">Revenue impact simulator</h1>
          <p className="text-xs text-zinc-400 mt-0.5">Identify payment opportunities and estimate their impact.</p>
        </div>
      </header>

      {/* Main Workspace Grid (Section 13 layout) */}
      <section className="p-8 flex-1 max-w-5xl w-full mx-auto">
        ...
        {baseline && simulation ? (
          <div className="grid grid-cols-1 lg:grid-cols-3 border border-zinc-900 bg-zinc-950 rounded overflow-hidden divide-y lg:divide-y-0 lg:divide-x divide-zinc-900">
            
            {/* Column 1: CURRENT PERFORMANCE */}
            <div className="p-8 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <span className="text-[8px] text-zinc-550 block font-mono uppercase font-semibold">Transactions</span>
                  <span className="text-base font-bold text-zinc-200 font-mono">
                    {baseline.transactionCount.toLocaleString()}
                  </span>
                </div>
                <div>
                  <span className="text-[8px] text-zinc-550 block font-mono uppercase font-semibold">Average transaction</span>
                  <span className="text-base font-bold text-zinc-200 font-mono">
            ...
            <div className="p-8 space-y-6 flex flex-col justify-between">
              <div>
                ...
                <div className="mt-6 space-y-2">
                  <span className="text-[8px] text-zinc-550 block font-mono uppercase font-semibold">Expected improvement</span>
                  <span className="text-sm font-bold text-zinc-200 font-mono">
                    +{Math.max(0, successRate - baseline.successRate).toFixed(1)}%
                  </span>
                </div>
              </div>
              ...
              <div className="pt-6 border-t border-zinc-900 mt-6">
                <button
                  ...
                  className="w-full py-1.5 bg-zinc-900 hover:bg-zinc-850 border border-zinc-800 text-zinc-400 text-[9px] font-mono uppercase font-bold rounded transition-colors"
                >
                  Reset
                </button>
              </div>
            ...
            <div className="p-8 space-y-6 bg-zinc-900/10">
              ...
              <div className="space-y-6">
                <div>
                  <span className="text-[8px] text-zinc-500 block font-mono uppercase font-semibold">Additional successful payments</span>
                ...
                <div>
                  <span className="text-[8px] text-zinc-500 block font-mono uppercase font-semibold">Estimated payment volume</span>
          ...
          <div className="flex flex-col items-center justify-center h-64 text-zinc-500">
            ...
            <p className="text-xs font-mono uppercase">Calculating estimated impact...</p>
          </div>
        )}
        ...
        <div className="mt-6 flex items-start gap-2.5 text-[9px] leading-relaxed text-zinc-500 font-mono max-w-2xl">
          ...
          <p>
            Estimate based on historical transaction patterns. Actual results may vary.
          </p>
        </div>
      </section>
    </div>
